...
const Marvel = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:5000/api/superheroes/Marvel")
      .then((response) => setSuperheroes(response.data))
      .catch(() => toast.error("Error al cargar superhéroes de Marvel"));
  }, []);
  ...
  return (
    <div className="p-4">
      <h1 className="text-3xl font-bold mb-4">Superhéroes de Marvel</h1>
      <input
        type="text"
